...
const PasswordSent = () => {
  ...
  return (
    <View style={styles.passwordSentView}>
      <Image
      ...
      <Text style={styles.passwordSentText}>Password Sent</Text>
      <Image
        style={styles.yellowLightReady1Icon}
        resizeMode="cover"
        source={require('../assets/yellowlightready-1.png')}
      />
